...
var carousel = "<script>$('.carousel').carousel({interval: 5000 //changes the speed}) </script>";

/* Get all page. */
router.get('*', function(req, res, next) {
  res.render('navbar', { navbarHome: navbarHome});
  res.render('head', {title: title});
  next();
});

/* GET home page. */
router.get('/', function(req, res, next) {
  res.render('scripts', {specialjsfiles: carousel});
...
router.get('/contact', function(req, res, next) {
  res.render('contact', {specialjsfiles: contactimefile+jqbootstrapvalidationfile});
});
